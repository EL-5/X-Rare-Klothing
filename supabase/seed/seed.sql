...
insert into products (id, slug, name, description, sku, status, brand, category_id, tags, seo_title, seo_description, published_at) values
  ('30000000-0000-0000-0000-000000000001', 'oversized-graphic-tee', 'Oversized Graphic Tee', 'A relaxed-fit tee in heavyweight cotton jersey with a front chest print.', 'HF-TEE-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000011', array['tee','cotton','new-in'], 'Oversized Graphic Tee | High Fashion', 'Relaxed-fit heavyweight cotton tee with front chest print.', now()),
  ('30000000-0000-0000-0000-000000000002', 'straight-leg-denim', 'Straight Leg Denim', 'Rigid selvedge denim cut straight through the leg with a mid-rise waist.', 'HF-DNM-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000012', array['denim','new-in'], 'Straight Leg Denim | High Fashion', 'Rigid selvedge denim, straight leg, mid-rise.', now()),
  ('30000000-0000-0000-0000-000000000003', 'coach-jacket', 'Coach Jacket', 'Lightweight shell jacket with snap closure and packable hood.', 'HF-JKT-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000013', array['jacket','outerwear'], 'Coach Jacket | High Fashion', 'Lightweight shell jacket with packable hood.', now()),
  ('30000000-0000-0000-0000-000000000004', 'embroidered-hoodie', 'Embroidered Hoodie', 'Midweight fleece hoodie with tonal embroidered logo.', 'HF-HD-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000014', array['hoodie','best-seller'], 'Embroidered Hoodie | High Fashion', 'Midweight fleece hoodie with tonal embroidered logo.', now()),
  ('30000000-0000-0000-0000-000000000005', 'ribbed-tank-top', 'Ribbed Tank Top', 'Fitted ribbed-knit tank in a stretch cotton blend.', 'HF-TNK-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000021', array['top','new-in'], 'Ribbed Tank Top | High Fashion', 'Fitted ribbed-knit tank, stretch cotton blend.', now()),
  ('30000000-0000-0000-0000-000000000006', 'pleated-midi-skirt', 'Pleated Midi Skirt', 'Fluid pleated skirt that falls to mid-calf, finished with a satin waistband.', 'HF-SKT-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000022', array['skirt','best-seller'], 'Pleated Midi Skirt | High Fashion', 'Fluid pleated midi skirt with satin waistband.', now()),
  ('30000000-0000-0000-0000-000000000007', 'canvas-tote-bag', 'Canvas Tote Bag', 'Heavy-duty canvas tote with interior pocket and reinforced handles.', 'HF-BAG-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000003', array['bag','accessories'], 'Canvas Tote Bag | High Fashion', 'Heavy-duty canvas tote with reinforced handles.', now()),
  ('30000000-0000-0000-0000-000000000008', 'wool-blend-beanie', 'Wool Blend Beanie', 'Ribbed beanie in a soft wool blend with a folded cuff.', 'HF-CAP-001', 'active', 'High Fashion', '10000000-0000-0000-0000-000000000003', array['hat','accessories','new-in'], 'Wool Blend Beanie | High Fashion', 'Ribbed wool-blend beanie with folded cuff.', now());
