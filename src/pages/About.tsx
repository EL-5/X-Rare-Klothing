...
export function About() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-[var(--spacing-section-mobile)] lg:px-8 lg:py-[var(--spacing-section-desktop)]">
      ...
      <p className="mt-4 text-2xl font-semibold uppercase tracking-wide text-ink">Rare by design. Different by nature.</p>

      <div className="mt-8 flex flex-col gap-6 text-sm leading-relaxed text-ink/70">
        <p>
